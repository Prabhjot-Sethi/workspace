...
class VncPod(VncCommon):
    ...
    def _create_iip(self, pod_name, pod_namespace, proj_uuid, vn_obj, vmi, vmi_ip):
        ...
        iip_obj = InstanceIp(name=iip_name, instance_ip_address=vmi_ip,
    ...
    def vnc_pod_vmi_create(self, pod_id, pod_name, pod_namespace,
                           ...
                           proj_obj, vm_vmi, idx, network=None, vmi_ip=""):
        ...
        self._create_iip(pod_name, pod_namespace,
                         proj_obj.uuid, vn_obj, vmi, vmi_ip)
        return vmi_uuid
